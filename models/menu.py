            ...
            [
                ...
                (
                    ...
                    URL(
                        "admin",
                        "default",
                        "edit/%s/controllers/%s.py" % (_app, request.controller),
                    ),
                ),
                (
                    T("View"),
                    False,
                    URL("admin", "default", "edit/%s/views/%s" % (_app, response.view)),
                ),
                (
                    T("DB Model"),
                    False,
                    URL("admin", "default", "edit/%s/models/db.py" % _app),
                ),
                (
                    T("Menu Model"),
                    False,
                    URL("admin", "default", "edit/%s/models/menu.py" % _app),
                ),
                (
                    T("Config.ini"),
                    False,
                    URL("admin", "default", "edit/%s/private/appconfig.ini" % _app),
                ),
                (
                    T("Layout"),
                    False,
                    URL("admin", "default", "edit/%s/views/layout.html" % _app),
                ),
                (
                    T("Stylesheet"),
                    False,
